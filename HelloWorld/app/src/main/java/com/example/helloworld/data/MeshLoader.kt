...
import com.example.helloworld.utils.readFloat32LE
import com.example.helloworld.utils.readUIntLE
...
fun loadMesh(
    assets: AssetManager, name: String,
    materials: Map<String, MaterialInstance>, engine: Engine
): Mesh {
